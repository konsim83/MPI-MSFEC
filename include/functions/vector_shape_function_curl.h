#ifndef INCLUDE_FUNCTIONS_VECTOR_SHAPE_FUNCTION_CURL_H_
#define INCLUDE_FUNCTIONS_VECTOR_SHAPE_FUNCTION_CURL_H_
...
#include <functions/vector_shape_function_curl.tpp>

#endif /* INCLUDE_FUNCTIONS_VECTOR_SHAPE_FUNCTION_CURL_H_ */
