#ifndef INCLUDE_MY_VECTOR_TOOLS_H_
#define INCLUDE_MY_VECTOR_TOOLS_H_
...
namespace MyVectorTools
{
  ...
  {
    extern template void
    assemble_projection<3, LaplaceProblem::ExactSolutionLin_B_div>(
      const DoFHandler<3> &                         dof_handler,
      const AffineConstraints<double> &             constraints,
      const Quadrature<3> &                         quad_rule,
      const LaplaceProblem::ExactSolutionLin_B_div &my_function,
      TrilinosWrappers::SparseMatrix &              system_matrix,
      TrilinosWrappers::MPI::Vector &               system_rhs,
      const MPI_Comm & /* mpi_communicator */);

    extern template void
    assemble_projection<3, LaplaceProblem::ExactSolutionLin>(
      const DoFHandler<3> &                   dof_handler,
      const AffineConstraints<double> &       constraints,
      const Quadrature<3> &                   quad_rule,
      const LaplaceProblem::ExactSolutionLin &my_function,
      TrilinosWrappers::SparseMatrix &        system_matrix,
      TrilinosWrappers::MPI::Vector &         system_rhs,
      const MPI_Comm & /* mpi_communicator */);
    ...
    extern template void
    assemble_projection<3, LaplaceProblem::ExactSolutionLin_A_curl>(
      const DoFHandler<3> &                          dof_handler,
      const AffineConstraints<double> &              constraints,
      const Quadrature<3> &                          quad_rule,
      const LaplaceProblem::ExactSolutionLin_A_curl &my_function,
      TrilinosWrappers::SparseMatrix &               system_matrix,
      TrilinosWrappers::MPI::Vector &                system_rhs,
      const MPI_Comm & /* mpi_communicator */);
  ...
  extern template void
  project_on_fe_space<3, LaplaceProblem::ExactSolutionLin_B_div>(
    const DoFHandler<3> &                         dof_handler,
    const AffineConstraints<double> &             constraints,
    const Quadrature<3> &                         quad_rule,
    const LaplaceProblem::ExactSolutionLin_B_div &my_function,
  ...
  extern template void
  project_on_fe_space<3, LaplaceProblem::ExactSolutionLin>(
    const DoFHandler<3> &                   dof_handler,
    const AffineConstraints<double> &       constraints,
    const Quadrature<3> &                   quad_rule,
    const LaplaceProblem::ExactSolutionLin &my_function,
  ...
  extern template void
  project_on_fe_space<3, LaplaceProblem::ExactSolutionLin_A_curl>(
    const DoFHandler<3> &                          dof_handler,
    const AffineConstraints<double> &              constraints,
    const Quadrature<3> &                          quad_rule,
    const LaplaceProblem::ExactSolutionLin_A_curl &my_function,
...
#endif /* INCLUDE_MY_VECTOR_TOOLS_H_ */
